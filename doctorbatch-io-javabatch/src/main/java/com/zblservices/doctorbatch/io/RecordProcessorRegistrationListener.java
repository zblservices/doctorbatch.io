 ...
 */
public class RecordProcessorRegistrationListener implements StepListener {
	...
	public void afterStep() throws Exception {
		SimpleProcessor.getDMBSProcessor().removeProcessorInstance();
	}
	...
	public void beforeStep() throws Exception {
		...
		SimpleProcessor.getDMBSProcessor().setRecordProcessor(recordProcessor);
	}
